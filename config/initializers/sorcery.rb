...
Rails.application.config.sorcery.submodules = [:external, :remember_me, :reset_password, :activity_logging, :external]
...
Rails.application.config.sorcery.configure do |config|
  ...
  #
  config.twitter.key = "Pu4gdjz7xB7dPYIPhGtqAoSTr"
  config.twitter.secret = "W5JBCNuD0gWgNVvsNdrUVKe8n0r8x9rGaVlKPYZuy1TdUmme9G"
  config.twitter.callback_url = "#{Rails.application.secrets.sorcery_github_callback_url}"
